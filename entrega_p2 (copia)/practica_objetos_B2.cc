...
// tipos
typedef enum{CUBO, PIRAMIDE, OBJETO_PLY, ROTACION, EXTRUSION, CILINDRO,CONO,ESFERA,PLY_REV} _tipo_objeto;
...
_cono cono(0.5,1,12);
_esfera esfera(0.5,8,12);
_ply_revolucion ply_rev;
...
switch (t_objeto){
	...
	case PIRAMIDE: piramide.draw(modo,1.0,0.0,0.0,5);break;
		...
		case PLY_REV : ply_rev.draw(modo,1.0,0.6,0.0,5);break;
...
switch (toupper(Tecla1)){
	...
	case '4':modo=SOLID_COLORS;break;
		...
		case 'F':t_objeto=ESFERA;break;
        case 'O':t_objeto=OBJETO_PLY;break;	
        case 'R':t_objeto=ROTACION;break;
        case 'X':t_objeto=EXTRUSION;break;
		case 'G':t_objeto=PLY_REV;break;
	}
glutPostRedisplay();
}
...
//Compruebo si se le ha pasado algun archivo ply como argumento 
